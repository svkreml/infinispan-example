...
public class TtlSpringRemoteCacheManager implements org.springframework.cache.CacheManager {
     ...
     */
    public TtlSpringRemoteCacheManager(final RemoteCacheManager nativeCacheManager, boolean reactive, long readTimeout, long writeTimeout, long ttl) {
        this.ttl = ttl;
    ...
    public SpringCache getCache(final String name) {
        ...
        return springCaches.computeIfAbsent(name, n -> new TtlSpringCache(nativeCache, reactive, readTimeout, writeTimeout, ttl));
    }
